        ...
        {jobs.map((job, index) => (
          <div key={job.begin.month + job.begin.year} className="relative">
            ...
            <div className={`mt-20 md:mt-0 relative md:w-1/2 ${(index + 1) % 2 === 1 ? 'md:ml-0 md:mr-auto md:pr-16' : 'md:ml-auto md:pl-16'}`} >
              ...
              <div className="rounded-md border-2 border-gray-900 dark:border-gray-500 overflow-hidden bg-white dark:bg-gray-900 ">
                <h2 className="p-4 text-xl uppercase text-white font-bold bg-gray-900 dark:bg-gray-500">{job.company
